...
namespace FreelancingApp.WebApp.Controllers
{
    public class CompaniesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CompanyName,Description,PhotoUrl")] Company company)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CompanyName,Description,PhotoUrl")] Company company)
        {
            if (id != company.Id)
            {
                return NotFound();
